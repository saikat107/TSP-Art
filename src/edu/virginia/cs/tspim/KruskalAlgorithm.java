...

{
	 ...
	 * }
	 * 
	 * } for(int i=0;i<number_of_vertices;i++) { for(int
	 * j=0;j<number_of_vertices;j++) System.out.print(adjacency_matrix[i][j]+
	 * "\t"); System.out.println(); }
	 * 
	 * KruskalAlgorithm kruskalAlgorithm = new
	 * KruskalAlgorithm(number_of_vertices);
	 * 
...
/*
 * 
 * 0 6 8 6 0 0 6 0 0 5 10 0 8 0 0 7 5 3 6 5 7 0 0 0 0 10 5 0 0 3 0 0 3 0 3 0
 */
=======
package edu.virginia.cs.tspim;
...

{
...

	{
		...
		System.out.println(tree.size());
		wr.close();
		Image im = TourExtractor.extractTourImage(tree, 700, 700 );
		im.showImage();
